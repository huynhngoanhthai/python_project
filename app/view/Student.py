...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.QDateANS.setDateTime(QtCore.QDateTime(
            QtCore.QDate(2001, 11, 4), QtCore.QTime(0, 0, 0)))
        self.QDateANS.setMaximumDateTime(QtCore.QDateTime(
            QtCore.QDate(2020, 11, 30), QtCore.QTime(23, 59, 59)))
        ...
        self.QTableUpdate.setEditTriggers(QtWidgets.QAbstractItemView.AnyKeyPressed | QtWidgets.QAbstractItemView.CurrentChanged |
        ...
        self.QTableUpdate.setVerticalScrollMode(
            QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.QTableUpdate.setHorizontalScrollMode(
            QtWidgets.QAbstractItemView.ScrollPerPixel)
        ...
        self.QDateUNgaySinh.setDateTime(QtCore.QDateTime(
            QtCore.QDate(2001, 11, 4), QtCore.QTime(0, 0, 0)))
        self.QDateUNgaySinh.setMaximumDateTime(QtCore.QDateTime(
            QtCore.QDate(2020, 12, 31), QtCore.QTime(23, 59, 59)))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_13.setText(_translate(
            "MainWindow", "password của Sinh trùng với MaSV"))
        ...
        self.tab.setTabText(self.tab.indexOf(self.Add),
        ...
        self.label_2.setText(_translate(
            "MainWindow", "Press Enter for suggest"))
        ...
        self.QDateUNgaySinh.setDisplayFormat(
            _translate("MainWindow", "d/M/yyyy"))
        self.label_25.setText(_translate("MainWindow", "Email"))
        self.tab.setTabText(self.tab.indexOf(self.Update),
        ...
        self.QLineDMaSV.setPlaceholderText(
            _translate("MainWindow", "MA SINH VIEN"))
        self.QLineDTenSV.setPlaceholderText(
            _translate("MainWindow", "TEN SINH VIEN"))
        self.tab.setTabText(self.tab.indexOf(self.Delete),
        ...
        self.label_16.setText(_translate(
            "MainWindow", "Press Enter for suggest"))
        self.QLineSAMaSV.setPlaceholderText(
            _translate("MainWindow", "MA SINH VIEN"))
        self.QLineSATenSV.setPlaceholderText(
            _translate("MainWindow", "TEN SINH VIEN"))
        ...
        item.setText(_translate("MainWindow", "Email"))
        self.tab.setTabText(self.tab.indexOf(self.ShowAll),
                            _translate("MainWindow", "ShowAll"))
